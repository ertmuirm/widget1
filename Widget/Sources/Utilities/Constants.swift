...
enum CustomIcons {
    ...
    static let all: [(name: String, label: String)] = [
        ...
        ("wi_chart",        "Chart"),
        // Health & Lifestyle
        ("wi_dumbbell",     "Dumbbell"),
        ("wi_food",         "Food"),
        ("wi_coffee",       "Coffee"),
        ("wi_hospital",     "Hospital"),
        // Home & Security
        ("wi_door",         "Door"),
        ("wi_shield",       "Shield"),
        ("wi_eye",          "Eye"),
        ("wi_fingerprint",  "Fingerprint"),
        // Misc
        ("wi_badge",        "Badge"),
        ("wi_book",         "Book"),
        ("wi_crown",        "Crown"),
        ...
        ("wi_gamepad",      "Game"),
        ("wi_grid",         "Grid"),
        ("wi_hourglass",    "Hourglass"),
        ("wi_id",           "ID Card"),
        ("wi_location",     "Location"),
        ("wi_palette",      "Palette"),
