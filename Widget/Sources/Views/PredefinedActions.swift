...
let predefinedApps: [AppActionGroup] = [
    ...
    AppActionGroup(category: "", name: "Citibank",           openURL: bundleIDURL("com.citibank.CitibankSG", fallback: "citi://"), deepLinks: []),
    ...
    AppActionGroup(category: "", name: "DBS digibank",       openURL: bundleIDURL("com.dbs.sg.iwealth", fallback: "dbsnow://"), deepLinks: []),
    ...
    AppActionGroup(category: "", name: "McDonald's",         openURL: bundleIDURL("com.mcdonalds.mobileapp", fallback: "mcdonalds://"), deepLinks: []),
    ...
    AppActionGroup(category: "", name: "Safari",             openURL: bundleIDURL("com.apple.mobilesafari", fallback: "https://"), deepLinks: [
        DeepLink(name: "Open URL",               urlString: "https://"),
        DeepLink(name: "Private Tab",            urlString: "x-safari-https://"),
    ]),
    ...
    AppActionGroup(category: "", name: "Shopee",             openURL: bundleIDURL("com.beeasy.shopee.sg", fallback: "shopeesg://"), deepLinks: []),
